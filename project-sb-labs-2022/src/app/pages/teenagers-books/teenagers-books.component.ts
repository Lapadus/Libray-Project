...
@Component({
  selector: 'app-teenagers-books',
  templateUrl: './teenagers-books.component.html',
  styleUrls: ['./teenagers-books.component.scss']
})
export class TeenagersBooksComponent implements OnInit {
